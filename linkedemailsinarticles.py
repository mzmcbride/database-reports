...
report_title = config.get('dbreps', 'rootpage') + 'Articles containing linked e-mail addresses'

report_template = u'''
Articles containing linked e-mail addresses; data as of <onlyinclude>%s</onlyinclude>.
