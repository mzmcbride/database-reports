...
report_title = config.get('dbreps', 'rootpage') + 'File description pages containing no templates or categories'

report_template = u'''
File description pages containing no templates or categories (limited to the \
first 800 entries); data as of <onlyinclude>%s</onlyinclude>.
