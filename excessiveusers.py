...
report_title = config.get('dbreps', 'rootpage') + 'Unusually long user blocks'

report_template = '''
Unusually long (more than two years) blocks of users; data as of <onlyinclude>%s</onlyinclude>.
