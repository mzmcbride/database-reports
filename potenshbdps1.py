...
report_title = config.get('dbreps', 'rootpage') + 'Potential biographies of dead people (1)'

report_template = u'''
Articles that transclude {{tl|BLP unsourced}} that are not categorized \
in [[:Category:Living people]] or [[:Category:Possibly living people]] \
and are in a "XXXX deaths" category; data as of <onlyinclude>%s</onlyinclude>.
