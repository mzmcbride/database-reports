...
report_template = u'''
Redirects whose page length is greater than 449 bytes; data as of <onlyinclude>%s</onlyinclude>.
...
report = wikipedia.Page(site, 'Wikipedia:Database reports/Redirects obscuring page content')
