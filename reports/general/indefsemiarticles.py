...
"""
Report class for indefinitely semi-protected articles
"""
...
class report(reports.report):
    ...
    def get_title(self):
        return 'Indefinitely semi-protected articles'

    def get_preamble_template(self):
        return 'Articles that are indefinitely semi-protected from editing; data as of <onlyinclude>%s</onlyinclude>.'

    def get_table_columns(self):
        return ['Article', 'Protector', 'Timestamp', 'Reason']
    ...
    def get_table_rows(self, conn):
        ...
        for page_title, user_name, log_timestamp, log_comment in cursor:
            ...
            yield [u'{{plth|1=%s}}' % page_title, u'[[User talk:%s|]]' % user_name, log_timestamp, u'<nowiki>%s</nowiki>' % log_comment]
