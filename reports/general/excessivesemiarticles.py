...
"""
Report class for Semi-protected articles with unusually long expiries
"""
...
class report(reports.report):
    def get_title(self):
        return 'Semi-protected articles with unusually long expiries'
    ...
    def get_preamble(self, conn):
        ...
        return 'Articles that are semi-protected from editing for more than one year; data as of <onlyinclude>%s</onlyinclude>.' % current_of
    ...
    def get_table_rows(self, conn):
        ...
        for page_is_redirect, page_title, pr_expiry in cursor:
            ...
            yield [page_title, user, timestamp, pr_expiry, comment]
