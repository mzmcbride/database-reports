...
class report(reports.report):
    ...
    def get_preamble(self, conn):
        ...
        return u'''Categories that contain "(wikipedian|\\buser)", "wikiproject" and "participants", or "wikiproject" and "members"; data as of <onlyinclude>%s</onlyinclude>.''' % current_of
