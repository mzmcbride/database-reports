...
report_title = config.get('dbreps', 'rootpage') + 'User template redirects'

report_template = u'''
Pages in the Template namespace that redirect to the User namespace; \
